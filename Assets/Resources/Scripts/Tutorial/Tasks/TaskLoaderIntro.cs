...
public class TaskLoaderIntro : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        taskManager.AddTask(new Task(2, "Aprende a saltar", "Parece que el Dubitador a dejado trampas por el camino. Saltalas usando el Joystick hacia arriba", true, 0f, true, jumpTaskAudio));
